...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _models_MenuSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../models/MenuSection */ "./src/app/models/MenuSection.ts");
/* harmony import */ var _models_Dish__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../models/Dish */ "./src/app/models/Dish.ts");
...
/* harmony import */ var _models_Order__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../models/Order */ "./src/app/models/Order.ts");
/* harmony import */ var _models_OrderStatus__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../models/OrderStatus */ "./src/app/models/OrderStatus.ts");
...
var SingleRestaurantComponent = /** @class */ (function () {
    function SingleRestaurantComponent(mainService, dataService, activatedRoute, appComponent) {
        ...
        this.menuSections = [];
        this.ordDishes = [];
        this.sectionsForChange = [];
        this.newMenuSection = new _models_MenuSection__WEBPACK_IMPORTED_MODULE_3__["MenuSection"]();
        this.newSectName = '';
        this.newDish = new _models_Dish__WEBPACK_IMPORTED_MODULE_4__["Dish"]();
        this.showChangeDish = [];
        this.newOrder = new _models_Order__WEBPACK_IMPORTED_MODULE_7__["Order"]();
        this.restaurantName = '';
        this.showSect = [];
    }
    ...
    SingleRestaurantComponent.prototype.placeOrder = function () {
        ...
        this.newOrder.status = _models_OrderStatus__WEBPACK_IMPORTED_MODULE_8__["OrderStatus"].ORDERED;
        this.mainService.placeOrder(this.newOrder, localStorage.getItem('_userId'), this.restaurantId)
            .subscribe(function (val) {
            console.log(val);
            _this.newOrder = new _models_Order__WEBPACK_IMPORTED_MODULE_7__["Order"]();
            _this.totalAmount = 0;
            _this.totalCost = 0;
            _this.cancel();
